...
class UpdateConfiguracionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'porcentaje_regla_prevale' => ['required', 'numeric', 'min:1', 'max:100'],
            'tolerancia_regla_prevale' => ['required', 'numeric', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'porcentaje_regla_prevale.required' => 'El porcentaje sobre el límite de crédito para el tope de vale es obligatorio.',
            'porcentaje_regla_prevale.min' => 'El porcentaje de tope de vale debe ser al menos 1%.',
            'porcentaje_regla_prevale.max' => 'El porcentaje de tope de vale no puede superar el 100%.',
            'tolerancia_regla_prevale.required' => 'El monto adicional / margen fijo por vale es obligatorio.',
            'tolerancia_regla_prevale.min' => 'El monto adicional fijo no puede ser negativo.',
