...
class UpdateProductoValeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'monto_prestamo' => ['sometimes', 'required', 'numeric', 'min:100', 'max:1000000'],
            'costo_seguro' => ['sometimes', 'required', 'numeric', 'min:0', 'max:100000'],
    ...
    public function messages(): array
    {
        return [
            ...
            'clave.unique' => 'Esta clave de vale ya se encuentra registrada en otro producto.',
    ...
    protected function prepareForValidation(): void
    {
        $data = [];
        if ($this->has('clave')) {
            $data['clave'] = strtoupper(trim($this->clave));
        }
        if ($this->has('nombre')) {
