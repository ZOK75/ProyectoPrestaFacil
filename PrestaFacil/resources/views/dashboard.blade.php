    ...
    <div class="space-y-6">
        <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h3 class="text-lg font-bold text-white">¡Has iniciado sesión correctamente!</h3>
                    <p class="text-slate-400 text-sm mt-1">Bienvenido, {{ auth()->user()->name }} &bull; {{ auth()->user()->email }}</p>
                </div>
