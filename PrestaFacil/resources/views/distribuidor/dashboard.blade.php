...
<div class="max-w-md mx-auto space-y-4 pb-8">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-xl relative overflow-hidden">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            @endphp
            <span class="px-2.5 py-1 rounded-full text-[10px] font-extrabold border uppercase tracking-wider shrink-0 {{ $catStyle }}">
                ★ {{ ucfirst($cat) }}
            </span>
        </div>
    </div>
                    ...
                    <div class="bg-slate-950/70 border border-slate-800/80 rounded-xl p-3 space-y-2">
                        <div class="flex items-start justify-between gap-2">
                            ...
                            @elseif($sol->estado === 'aprobada')
                                <span class="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shrink-0">
                                    ✓ Aprobada
                                </span>
                            @else
                                <span class="px-2 py-0.5 rounded-full text-[10px] font-bold bg-rose-500/10 text-rose-400 border border-rose-500/20 shrink-0">
                                    ✕ Rechazada
                                </span>
                            @endif
                        </div>
