...
<head>
    ...
    <title>PrestaFácil - Sesión Expirada</title>
...
<body class="bg-slate-950 text-slate-100 flex items-center justify-center min-h-screen p-4 font-sans antialiased selection:bg-rose-500 selection:text-white">
    <div class="max-w-lg w-full text-center space-y-6 bg-slate-900 border border-slate-800 p-8 sm:p-10 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <div class="absolute -top-24 -left-24 w-56 h-56 bg-emerald-500/15 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute -bottom-24 -right-24 w-56 h-56 bg-teal-500/15 rounded-full blur-3xl pointer-events-none"></div>

        <!-- Badge de Estado -->
        <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/30">
        ...
        <div class="relative w-20 h-20 mx-auto flex items-center justify-center">
            <div class="w-20 h-20 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl flex items-center justify-center text-emerald-400 shadow-inner">
        ...
        <div class="space-y-2.5">
            ...
            <p class="text-sm text-slate-300 leading-relaxed max-w-md mx-auto">
                {{ $exception->getMessage() ?: 'Por razones de seguridad, la sesión caducó debido a un periodo prolongado de inactividad.' }}
            </p>
        </div>
        ...
        <div class="bg-slate-950/70 border border-slate-800/90 rounded-2xl p-4 text-left space-y-2 text-xs text-slate-400">
            ...
            <ul class="space-y-1.5 list-disc list-inside text-slate-400">
                <li>Mantuviste la pestaña abierta sin realizar acciones por mucho tiempo.</li>
                <li>Intentaste enviar un formulario cuyo token de seguridad (CSRF) se venció.</li>
                <li>Tu sesión fue terminada desde otro dispositivo.</li>
            </ul>
        </div>
