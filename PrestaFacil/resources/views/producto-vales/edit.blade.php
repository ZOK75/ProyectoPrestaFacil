...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-6">
        ...
        @else
            <div class="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-sm flex items-start gap-2.5">
                ...
                <span><strong>Nota:</strong> Los parámetros del vale (montos, seguros y plazos) no se pueden alterar después de creados. La única acción permitida en la edición es la <strong>desactivación permanente</strong> del vale.</span>
            </div>
        @endif
